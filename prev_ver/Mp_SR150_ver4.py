        ...
        while q:
            try:
                ...
                if id == '11':
                    ...
                    # self.KF.cnt1 += 1
                    self.KF.cnt1 = 2
                    kf_x1, kf_y1 = round(self.KF.X1[0][0],3), round(self.KF.X1[1][0],3)
                    ...
                    # self.KF.cnt2 += 1
                    self.KF.cnt2 = 2
                    kf_x2, kf_y2 = round(self.KF.X2[0][0],3), round(self.KF.X2[1][0],3)
                    ...
                    # self.KF.cnt3 += 1
                    self.KF.cnt3 = 2
                    kf_x3, kf_y3 = round(self.KF.X3[0][0],3), round(self.KF.X3[1][0],3)
                    ...
                    # self.KF.cnt4 += 1
                    self.KF.cnt4 = 2
                    kf_x4, kf_y4 = round(self.KF.X4[0][0],3), round(self.KF.X4[1][0],3)
